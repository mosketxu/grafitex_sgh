...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Permission::create(['name'=>'Usuarios Mostrar','slug'=>'user.show','description'=>'Ver en detalle cada usuario del sistema',]);
        ...
        // Permission::create(['name'=>'Roles Mostrar','slug'=>'roles.show','description'=>'Ver en detalle cada rol del sistema',]);
        ...
        // Permission::create(['name'=>'Permisos Mostrar','slug'=>'permission.show','description'=>'Ver en detalle cada permiso del sistema',]);
        ...
        // Permission::create(['name'=>'Campañas Mostrar','slug'=>'campaign.show','description'=>'Ver en detalle cada campaña del sistema',]);
        ...
        // Permission::create(['name'=>'Presupuestos Mostrar','slug'=>'presupuesto.show','description'=>'Ver en detalle cada prespuesto del sistema',]);
        ...
        // Permission::create(['name'=>'Stores Mostrar','slug'=>'store.show','description'=>'Ver en detalle cada store del sistema',]);
        ...
        // Permission::create(['name'=>'Elementos Mostrar','slug'=>'elemento.show','description'=>'Ver en detalle cada elemento del sistema',]);
        ...
        // Permission::create(['name'=>'Store Elementos Mostrar','slug'=>'storeelementos.show','description'=>'Ver en detalle cada elemento de la store del sistema',]);
        ...
        // Permission::create(['name'=>'Tarifas Mostrar','slug'=>'tarifa.show','description'=>'Ver en detalle cada tarifa del sistema',]);
        ...
        // Permission::create(['name'=>'Tarifa Familia Mostrar','slug'=>'tarifafamilia.show','description'=>'Ver en detalle cada tarifa familia del sistema',]);
        ...
        // Permission::create(['name'=>'Maestro Mostrar','slug'=>'maestro.show','description'=>'Ver en detalle cada Maestro del sistema',]);
        ...
        // Permission::create(['name'=>'Auxiliares Mostrar','slug'=>'auxiliares.show','description'=>'Ver en detalle cada Auxiliares del sistema',]);
